...
coxm <- cph(Surv(dds,ddstat)~Stage+Group+tumorsizegroup+Location+lymphaenectomy+op__modified_titlerecode+adjuve0t_chemo+agegroup+sex+bmigroup,x=T,y=T,data=gc,surv=T)
...
pdf('Nomogram_Cox.pdf',height=20,width=15)
plot(nomogram(coxm,fun=list(surv1,surv2,surv3),lp=F,funlabel=c('1-year Survival','3-year Survival','5-year Survival'),maxscale=100,fun.at=c('0.9','0.85','0.80','0.70','0.6','0.5','0.4','0.3','0.2')))
dev.off()
