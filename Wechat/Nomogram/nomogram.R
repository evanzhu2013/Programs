...
f <- lrm(y ~ x1 + x2 + x3)
# nomogram
nom <- nomogram(scoxm, fun=list(surv1,surv2,surv3),lp=F, maxscale=10, fun.at=c(0.95,0.9,0.85,0.8,0.75,0.7,0.6,0.5))
plot(nom)
...
# g <- lrm(y~sex*rcs(cholesterol,4)+lsp(age,50)+blood.pressure)
