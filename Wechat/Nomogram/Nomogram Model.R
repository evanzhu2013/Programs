...
coxm <- cph(Surv(dds,ddstat)~Stage+tumorsizegroup+Group+Location+lymphaenectomy+op__modified_title+adjuve0t_chemo+agegroup+sex+bmigroup,x=T,y=T,data=gc,surv=T)
...
plot(nomogram(coxm,fun=list(surv1,surv2,surv3),lp= F,funlabel=c('1-yearsurvival','3-yearsurvival','5-year survival'),maxscale=10,fun.at=c('0.9','0.85','0.80','0.70','0.6','0.5','0.4','0.3','0.2')))
