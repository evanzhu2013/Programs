...
sheet4 = read.csv('/Users/Evan/DataScience/R-Programming/PCR/csv/sheet4.csv',header=T)[-c(6,12),1:2]

# sheet4 = read.csv('/Users/Evan/DataScience/Working/Graph/csv/sheet4.csv',header=T) 导入数据
# sheet4 = sheet4[-c(6,12),1:2] 将第6和12空行删除
